package com.striyank.globotour.favorite
...
class FavoriteFragment : Fragment() {
    ...
    /**An instance of ItemTouchHelper class**/
    private val itemTouchHelper = ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(
        ItemTouchHelper.UP or ItemTouchHelper.DOWN, ItemTouchHelper.RIGHT) {

        /**Responsible for dragging items**/
        override fun onMove(recyclerView: RecyclerView, viewHolder:
        RecyclerView.ViewHolder, targetViewHolder: RecyclerView.ViewHolder): Boolean {
